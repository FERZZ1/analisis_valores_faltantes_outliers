...
gg_miss_var(ventas, show_pct = TRUE) +
  labs(title = "Porcentaje de Valores Faltantes por Variable",
       x = "Variables",
       y = "Porcentaje (%)") +
  theme_minimal()
...
Wilcox, R. R. (2012). *Introduction to Robust Estimation and Hypothesis Testing* (3a ed.). Academic Press.

Lazar, N. A. (2013). *The Statistics of Practical Data Analysis: Dealing with Missing Data and Outliers*. Elsevier.

Afanador, J., & Pérez, M. (2020). Técnicas de imputación y su impacto en modelos predictivos. *Revista Latinoamericana de Estadística Aplicada*, 8(2), 45–60
